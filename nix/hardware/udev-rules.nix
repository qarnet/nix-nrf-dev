# nix-nrf-udev-rules is a thin relocation package exposing OpenOCD's canonical
...
# $out/share/openocd/contrib/60-openocd.rules. It preserves the upstream SPDX
# header and content, adds no repository VID/PID catalog or custom rules. The
